...
public class Main {
	...
	public static void main(String[] args) {
		...
		personBySalary.keySet().forEach(key -> {
			List<Person> listOfPerson = personBySalary.get(key);
			System.out.println("salary > 50000: " + key + " - " + listOfPerson.size() + " persons");
		});
		System.out.println("***********************************");
		...
		nameMap.forEach((key, value) -> {
			System.out.println("firstName: " + key + ", lastNames: " + value);
		});
		System.out.println("***********************************");
