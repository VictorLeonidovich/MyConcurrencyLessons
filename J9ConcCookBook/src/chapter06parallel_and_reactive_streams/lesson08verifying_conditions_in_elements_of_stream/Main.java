package chapter06parallel_and_reactive_streams.lesson08verifying_conditions_in_elements_of_stream;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		condition = persons.parallelStream().allMatch(p -> p.getSalary() > 50000);
		System.out.printf("Salary > 50000: %b\n", condition);
		condition = persons.parallelStream().allMatch(p -> p.getSalary() > 100000);
		System.out.printf("Salary > 100000: %b\n", condition);
